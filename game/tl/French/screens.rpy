...
translate French strings:
    ...
    new "{b}Utiliser le plan du texte?{/b}"

    # game/screens.rpy:251
    old "{i}(You can also change this, the textbox transparency, text color and more in the settings.){/i}"
    new "{i}(Vous pouvez également modifier ce paramètre, la transparence de la zone de texte, la couleur du texte et bien d'autres choses encore dans les paramètres..){/i}"
    ...
    new "{size=-10}{color=#ff0000}Toutes les traductions sont faites par des fans.{/color}{/size}"
    ...
    new "Transparence de la zone de texte"
